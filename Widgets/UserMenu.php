        ...
        return <<<'HTML'
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-inline">{$nameHtml}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <li class="user-header text-bg-primary">
                  <img src="{$imageHtml}" class="rounded-circle shadow" alt="User Image">
                  <p>
                    {$usernameHtml} - {$titleHtml}
                  </p>
                </li>
                <li class="user-footer">
                  <a href="{$profileLinkHtml}" class="btn btn-default btn-flat">Profile</a>
                  <a href="{$signoutLinkHtml}" class="btn btn-default btn-flat float-end">Sign out</a>
                </li>
              </ul>
            </li>
HTML;
